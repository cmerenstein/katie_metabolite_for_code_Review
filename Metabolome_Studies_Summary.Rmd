...
write_xlsx(lit_data, './Results/literature_metabolites.xlsx')
```
...
source_python("./HMDB/HMDB_interface.py")

#load metabolite database 
metabolite_DB <- read.csv2(file = './HMDB/hmdb_metabolites.csv', header = TRUE, stringsAsFactors = F, sep = ",")
...
matched_lit <- process_corrected_names(infile = './Results/lit_metabolites_key.csv', match_data = lit_data) #file name from interface py output
...
corrected_unmatched_lit <- read_xlsx(path = './Results/corrected_unmatched_literature_metabolites.xlsx') %>%
...
write_xlsx(corrected_unmatched_lit, './Results/HMDB_search2.xlsx')

#rerun py script with manually corrected names
source_python('./HMDB/HMDB_search.py')
HMDB_search_fun(infile ="./Results/HMDB_search2.xlsx" , key_file = './Results/HMDB_search2_key.csv')

#match names from HMDB with corrected_unmatched_lit
match2 <- read.csv2(file = "./Results/HMDB_search2_key.csv", header = FALSE, stringsAsFactors = F, sep = ",") %>%
  rename('traditional_iupac' = V1, 'name_search' = V2) %>%
